classdef Visualizer2D < matlab.System & matlab.system.mixin.CustomIcon
    ...
    properties(Nontunable)  % Propiedades no sintonizables, no pueden cambiarse una vez que la instancia del objeto ha sido creada.
    ...
    methods(Access = protected)
        ...
        function setupImpl(obj)
            ...
            % Initialize waypoints, puntos de referencia
            if obj.hasWaypoints
